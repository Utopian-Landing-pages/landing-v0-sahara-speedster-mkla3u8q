...
export const metadata: Metadata = {
  title: 'Sahara Speedster - Run, Jump, Explore with Magical Powers',
  description: 'Experience a fast-paced platformer inspired by Arabic mythology. Harness magical powers, explore stunning desert landscapes, and embark on an epic adventure.',
  generator: 'v0.app',
  icons: {
    icon: [
      {
...
export default function RootLayout({
  ...
  var TOKEN="982e0ec1-d4e7-4dab-a0be-861f0d3f4e1dcb51a01e1d6c2248b2e21af343f7a1f7";
